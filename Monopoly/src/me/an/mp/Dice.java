...
public class Dice implements MouseListener, MouseMotionListener
{
	...
	private boolean waitingPlayer = false, updating = false, doneRolling = false, hasRolled = false, movePlayer = true, moveIfDoubles = false;
	...
	public void rollWithoutMove(Player player)
	{
		movePlayer = false;
		waitingPlayer = false;
		playerRolling = player;
	...
	public void rollMoveIfDoubles(Player player)
	{
		moveIfDoubles = true;
		waitingPlayer = false;
		playerRolling = player;
	...
	public void update()
	{
		...
		if (doneRolling)
		{
			...
			{
				if (movePlayer || (moveIfDoubles && isDoubles()))
	...
	public void mousePressed(MouseEvent e)
	{
		...
		if (playerRolling.inJail())
			rollMoveIfDoubles(playerRolling);
		else
			roll(playerRolling);
	}
